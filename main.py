...
def main():
    ...
    if args.local_rank == 0:
        ...
        _logger.info('Training args: {}'.format(args))
    ...
    if args.local_rank == 0:
        ...
        _logger.info(f"Start training for {num_epochs} epochs from epoch {start_epoch}")
...
def validate(model, loader, loss_fn, args, amp_autocast=suppress, log_suffix=''):
    ...
    if args.local_rank == 0:
        _logger.info('epoch eval Acc@1: {top1.avg:>7.4f}   ''Acc@5:{top5.avg:>7.4f}'.format(top1=top1_m, top5=top5_m))
